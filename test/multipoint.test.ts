...
import { AxisSelectionType, Charac_DB_MP, CharacTypeMP_4_1_3, Multipoint_Threshold_ID_DATA, MultipointThresholdCommModeType, MultipointThresholdConfigType, MultipointThresholdHL, MultipointThresholdLevelType, MultipointThresholdRequestType, PresetConfigurationType, PresetRequestType, PresetSelectionType, WindowConfigurationType, WindowingFunctionType, WindowRequestType } from "../src/Sensors/4.1.3/MP";
import { FirmwareVersion, DeviceModel, Operation, UserPayloadType } from "../src/Sensors/Mapping";
...
describe('AXIS SELECTION', () => {
    ...
    it('Write X+Y Axis Selection', () => {
        let payload: AxisSelectionType = { axis_selected: ["x", "y"], type: CharacTypeMP_4_1_3.AXIS_SELECTION }
...
describe('PRESET SELECTION', () => {
    ...
    it('Write Select Preset 2 for Meas slot 1', () => {
        let payload: PresetSelectionType = { main_preset: 2, type: CharacTypeMP_4_1_3.PRESET_SELECTION }
    ...
    it('Write Select Preset 2 for Meas slot 1 and Preset 6 for Meas slot 2 (rotating)', () => {
        let payload: PresetSelectionType = { main_preset: 2, secondary_preset: 6, type: CharacTypeMP_4_1_3.PRESET_SELECTION }
...
describe('WINDOWING FUNCTION SELECTION', () => {
    ...
    it('Write Windowing Flat top', () => {
        let payload: WindowingFunctionType = { function: "flattop", type: CharacTypeMP_4_1_3.WINDOWING_FUNCTION }
...
describe('PRESET CONFIGURATION', () => {
    ...
    it('Request Preset configuration', () => {
        let payload: PresetRequestType = { preset_id: 15, type: CharacTypeMP_4_1_3.PRESET_REQUEST }
    ...
    it('Write Preset configuration', () => {
        let payload: PresetConfigurationType = { preset_id: 15, frame_format: 1, bandwidth_mode: 10, meas_interval_hour: 255, meas_interval_minute: 15, meas_interval_second: 10, type: CharacTypeMP_4_1_3.PRESET_CONFIGURATION }
...
describe('WINDOW CONFIGURATION', () => {
    ...
    it('Request Window configuration', () => {
        let payload: WindowRequestType = { preset_id: 255, window_id: 8, type: CharacTypeMP_4_1_3.WINDOW_REQUEST }
    ...
    it('Write Window configuration', () => {
        let payload: WindowConfigurationType = { preset_id: 15, window_id: 2, enable: true, peak_count: 5, frequency_min: 600, frequency_max: 20000, type: CharacTypeMP_4_1_3.WINDOW_CONFIGURATION }
...
describe('THRESHOLD CONFIGURATION', () => {
    ...
    it('Request Threshold config configuration', () => {
        let payload: MultipointThresholdRequestType = { id_data: Multipoint_Threshold_ID_DATA.X_Analysis_window_RMS_of_window_1, param_sel: "communication_mode", type: CharacTypeMP_4_1_3.MULTIPOINT_THRESHOLD_REQUEST }
    ...
    it('Write Threshold config configuration', () => {
        let payload: MultipointThresholdConfigType = { id_data: Multipoint_Threshold_ID_DATA.X_Analysis_window_RMS_of_window_1, auto_clear: true, event_flag: false, enabled: true, direction: "above", param_sel: "ths_config", set_ble_mode: true, set_lora_mode: false, type: CharacTypeMP_4_1_3.MULTIPOINT_THRESHOLD }
    ...
    it('Write Threshold level configuration', () => {
        let payload: MultipointThresholdLevelType = { id_data: Multipoint_Threshold_ID_DATA.X_Analysis_window_RMS_of_window_1, level: 59000, param_sel: "ths_level", type: CharacTypeMP_4_1_3.MULTIPOINT_THRESHOLD }
    ...
    it('Write Threshold comm mode configuration', () => {
        let payload: MultipointThresholdCommModeType = { id_data: Multipoint_Threshold_ID_DATA.X_Analysis_window_RMS_of_window_1, param_sel: "communication_mode", ble_mode: "silent", lora_mode: "on_measurement", type: CharacTypeMP_4_1_3.MULTIPOINT_THRESHOLD }
    ...
    it('Write Multi-frame Threshold configuration', () => {
        let payload: MultipointThresholdHL = { id_data: Multipoint_Threshold_ID_DATA.X_Analysis_window_RMS_of_window_1, ble_mode: "silent", lora_mode: "on_measurement", auto_clear: true, event_flag: false, enabled: true, direction: "above", level: 59000, set_ble_mode: true, set_lora_mode: false, type: CharacTypeMP_4_1_3.MULTIPOINT_THRESHOLD_MULTI, multi_frame: true }
