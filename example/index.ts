...
import { BatteryType, CharacTypeCommon, Charac_DB_common, Operation, SensorFamily, UserPayloadType } from "../src/Schemas";
...
let frame = encode(Charac_DB_common.battery, Operation.READ, user_payload, SensorFamily.Singlepoint)
...
var battery_reset_payload: BatteryType = { reset: true, type: CharacTypeCommon.BATTERY }
console.log(encode(Charac_DB_common.battery, Operation.WRITE, battery_reset_payload).toHexString()) // Output string "01 2A 19 FF"
